...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    public Usuario crearPerfilVacio(String correoElectronico) {
        ...
        nuevoUsuario.setNombreCompleto("Usuario Nuevo"); // Valor por defecto ya que es NOT NULL
        nuevoUsuario.setContrasena("PROTEGIDA_EN_AUTH"); // La real está en el micro de identidad
